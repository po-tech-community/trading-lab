...
| ID      | Task                                                                                                                                                                                                                                                        | Scope | Deps             | Assignee    | Done | Notes                                                                                                                                                                                                                                                                      |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ---------------- | ----------- | ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| AI-FE-10 | **`/home/ai-advisor/settings` page** – Currently renders `<div className="p-8">AI Settings Page</div>`. Implement: API key status, model selection (if configurable), rate limit info, enable/disable MCP tools. **_Note: coordinate with Kha on MCP data structure before implementing toggle._** | M     | `router.tsx` | Quân Trương | -    |
