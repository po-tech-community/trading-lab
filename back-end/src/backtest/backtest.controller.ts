...
export class BacktestController {
    ...
    @ApiResponse({
        status: 201,
        description: 'Backtest completed. Returns summary (with per-asset breakdown) and timeline.',
    })
    @ApiResponse({
        status: 400,
        description:
    ...
    async runPortfolio(@Body() dto: RunPortfolioDcaBacktestDto) {
        ...
        const result = this.calculationService.runPortfolioDcaBacktest(seriesBySymbol, {
            assets: dto.assets,
